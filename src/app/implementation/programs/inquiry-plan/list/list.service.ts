...
export class ListService {
  ...
  //新增查询方案列表查询
  public queryschemaList(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/list/get', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  //查询字段
  public getFieldInfo(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/model/info/get', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  public saveDetail(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/detail', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  public getDetail(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/detail/get', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  public updateDetail(params): Observable<any> {
    const result = this.http.put(this.apiUrl + '/dqt/queryschema/detail', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  public deleteDetail(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/detail/delete', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  //执行运算
  public performOperation(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/detail/ooql/get', params, {
      headers: this.getHeader(),
    });
    return result;
  }
  ...
  //调用示例
  public callExample(params): Observable<any> {
    const result = this.http.post(this.apiUrl + '/dqt/queryschema/detail/example/get', params, {
      headers: this.getHeader(),
    });
    return result;
  }
